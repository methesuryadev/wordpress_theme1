        ...
        <div class="row justify-content-between">
            <div class="col-md-3 mb-4">
                <a class="mb-4 d-block" href="index.html">
                    <img class="img-fluid" width="150px" src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.png" alt="LogBook">
                </a>
...
<script src="<?php echo get_template_directory_uri(); ?>/assets/plugins/bootstrap/bootstrap.min.js" async></script>
